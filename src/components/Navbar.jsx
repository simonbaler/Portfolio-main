...
const Navbar = () => {
  ...
  const navLinks = ['Home', 'About', 'Skills', 'Projects', 'Updates', 'Contact'];

  const hireMeMailto = `mailto:simonbaler21@gmail.com?subject=Hiring Inquiry – Portfolio&body=Hello Simon Baler,%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;
